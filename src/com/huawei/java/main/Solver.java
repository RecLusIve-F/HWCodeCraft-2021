...
public class Solver {
    ...
    public Solver (IOUtils ioUtils, int totalDay, boolean isTest) {
...
//                System.out.println("1 " + (fixedCpu - getCpuFromNode) + " " + (fixedMemory - getMemoryFromNode));
//                System.out.println("2 " + getCpuFromVirtualMachineIDs + " " + getMemoryFromVirtualMachineIDs);
