...
public class IOUtils {
    ...
    public int readHost() {
        ...
        for (int i = 0; i < hostCount; i ++) {
            String[] hostInfo = parseString(scanner.nextLine());
    ...
    public int readVirtualMachine() {
        ...
        virtualMachineCount = Integer.parseInt(scanner.nextLine());
        for (int i = 0; i < virtualMachineCount; i ++) {
            String[] virtualMachineInfo = parseString(scanner.nextLine());
    ...
    public int readDailyRequest() {
        int requestNums = 0;
        requestNums = Integer.parseInt(scanner.nextLine());
        List<Request> requests = new ArrayList<>();
        for (int i = 0; i < requestNums; i ++) {
            String[] requestInfo = parseString(scanner.nextLine());
